...
# under the License.
#
# The Original Code is pb.py.
#
# The Initial Developers of the Original Code are Rabbit Technologies
# Ltd and Tony Garnock-Jones. Portions created before 24 July 2010
# 00:00:00 GMT by Rabbit Technologies Ltd or Tony Garnock-Jones are
# Copyright (C) 2010 Rabbit Technologies Ltd and Tony
# Garnock-Jones. Otherwise, portions created by Tony Garnock-Jones are
...
class DefaultConfiguration(Store):
    ...
    def create_projects(self):
        ...
        c_client = AutoreconfProject(self, "rabbitmq-c",
                                     self.github("rabbitmq", "rabbitmq-c"), [codegen],
                                     "librabbitmq",
